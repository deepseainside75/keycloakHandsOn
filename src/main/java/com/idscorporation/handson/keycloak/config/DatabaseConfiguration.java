...
@Configuration
@EnableJpaRepositories("com.idscorporation.handson.keycloak.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.idscorporation.handson.keycloak.repository.search")
